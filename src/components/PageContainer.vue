...
<template>
  <div class="cp-page-container">
    <div class="cp-page-cont-deco select-none w-100vw fixed inset-0 h-100vh overflow-hidden">
      ...
      <div class="md:block absolute -left-6 -top-4 ml-5 pointer-events-none -z-10"
        aria-hidden="true">
        <img 
